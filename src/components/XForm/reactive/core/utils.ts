import { __factory__, __reactive__ } from './global'
import { FactoryFunction, Key, Raw, ReactiveFunction } from './types'
...
export function isFactoryFunction(source: any): source is FactoryFunction {
  return typeof source === 'function' && source[__factory__]
}
